        ...
        {showHomePage ? (
          <>
            ...
            <div className="text-center mb-16">
              <img src="/logo.png" alt="Logo" className="mx-auto mb-4" style={{ width: '450px', height: 'auto'}}/>
              <GraduationCap className="h-28 w-28 mx-auto text-blue-600 mb-8 animate-pulse" />
